...
/***/ function(module, exports, __webpack_require__) {
	...
	var deepMatch = __webpack_require__(2);
	...
	function inject(renderer) {
	  window.__retractor = {
	    ...
	    findAllComponents: function (name, filter) {
	      return findAllComponentsInternal(renderer, name).filter(function (inst) {
	    ...
	    findAllDOMNodes: function (name, filter) {
	      return this.findAllComponents(name, filter).map(function (inst) {
	...
	function find(inst, test) {
	  ...
	  if (type.isDOMComponent(publicInst)) {
	    ...
	    for (key in renderedChildren) {
	      ...
	      ret = ret.concat(find(renderedChildren[key], test));
	    }
	  } else if (type.isValidElement(currentElement) && typeof currentElement.type === 'function') {
	    ret = ret.concat(find(inst._renderedComponent, test));
	  }
	  return ret;
	}
...
/***/ function(module, exports) {
	 ...
	 */
	var REACT_ELEMENT_TYPE = typeof Symbol === 'function' /* global Symbol */
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = function () {
	  return _react2.default.createElement(
	    'ul',
	    null,
	    _react2.default.createElement(_TodoItem2.default, { text: 'Test React App' }),
	    _react2.default.createElement(_TodoItem2.default, { text: 'Use Retractor' })
	  );
	};
